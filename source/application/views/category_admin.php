...
<div class="col-md-12">
	...
	<div class="row">
		<div class="col-md-6 col-sm-8 col-xs-8">
			<button type="button" class="btn btn-success btn-sm" onclick="demo_create();"><i class="glyphicon glyphicon-asterisk"></i> <?php echo $this->lang->line('AddCategory'); ?> </button>
			<button type="button" class="btn btn-warning btn-sm" onclick="demo_rename();"><i class="glyphicon glyphicon-pencil"></i> <?php echo $this->lang->line('Rename'); ?></button>
			<button type="button" class="btn btn-danger btn-sm" onclick="deleteCategory();"><i class="glyphicon glyphicon-remove"></i> <?php echo $this->lang->line('DeleteCategory'); ?></button>
		</div>
