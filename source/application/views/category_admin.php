...
<div class="col-md-12">
	...
	<div class="row">
		...
		<div class="col-md-2 col-sm-4 col-xs-4" style="text-align:right;">
			<input type="text" value="" style="box-shadow:inset 0 0 4px #eee; width:200px; margin:0; padding:6px 12px; border-radius:4px; border:1px solid silver; font-size:1.1em;" id="demo_q" placeholder="Претражи категорије">
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-2">
			<button type="button" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-asterisk"></i> Сачувај промене </button>
		</div>
	</div>
