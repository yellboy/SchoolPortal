				...
				<div class="dropdown">
					<?php 
						if ($category->ChildrenCount > 0){
							...
							echo '<a id="' . $category->Id . '" role="button" class="btn btn-primary" href="' . ResolveRoute(ContentPageCodes::CategoryDetails, $category) .'">';
						}
						...
						<ul class="dropdown-menu multi-level level2" role="menu" aria-labelledby="dropdownMenu">
							<?php 
								foreach ($category->Children as $level2){ 
									...
									{
										echo '<li><a href="' . ResolveRoute(ContentPageCodes::CategoryDetails, $level2) . '">' . $level2->Title . '</a></li>';
									}
									else
									{ 
							?>
							<li class="dropdown-submenu">
								...
								<ul class="dropdown-menu">
									<?php foreach ($level2->Children as $level3){ 
											...
											{
												echo '<li><a tabindex="-1" href="' . ResolveRoute(ContentPageCodes::CategoryDetails, $level3) . '">' . $level3->Title . '</a></li>';
											}
											else 
											{
									?>
									<li class="dropdown-submenu">
										...
										<ul class="dropdown-menu">
											<?php foreach ($level3->Children as $level4){
													echo '<li><a href="' . ResolveRoute(ContentPageCodes::CategoryDetails, $level4) . '">' . $level4->Title . '</a></li>';
												}
											?>
										</ul>
									</li>
