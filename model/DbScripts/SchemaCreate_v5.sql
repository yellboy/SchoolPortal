...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 26, 2015 at 07:16 PM
...
--
-- Table structure for table `categorcategoryrelation`
--

CREATE TABLE IF NOT EXISTS `categorcategoryrelation` (
...
--
-- Table structure for table `categorycontentrelation`
--

CREATE TABLE IF NOT EXISTS `categorycontentrelation` (
...
CREATE TABLE IF NOT EXISTS `content` (
  ...
  `CreatedByUser` bigint(20) NOT NULL,
  `Route` text CHARACTER SET cp1251 COLLATE cp1251_bin NOT NULL,
  `ContentType` tinyint(5) NOT NULL,
  `Content` text CHARACTER SET cp1251 COLLATE cp1251_bin NOT NULL,
  `FilePath` text CHARACTER SET cp1251 COLLATE cp1251_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `categorcategoryrelation`
--
ALTER TABLE `categorcategoryrelation`
 ADD PRIMARY KEY (`ParentCategoryId`,`SubCategoryId`);
...
--
-- Indexes for table `categorycontentrelation`
--
ALTER TABLE `categorycontentrelation`
 ADD PRIMARY KEY (`CategoryId`,`ContentId`);
